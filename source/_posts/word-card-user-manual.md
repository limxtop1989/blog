...
# 使用示例
比方说，dish是个初级词汇，我们很早就知道，它是盘子的意思，恐怕我们很多人也仅知道如此，但这对于我们语言表达还是词穷的。所以就算单词我们已经学过了，依然需要按照科学的方式重新学习。GoldenDict 一查，好家伙，居然还有这么名词意思。（后面的汉字是为了表达清晰，具体学习，千万别去想中文含义，原则依然是用英语学习英语，看到dish，不应该想到盘子，而是图画，或者英文释义或者例句，如果可以自己造句就更棒了）
...
# 单词卡片下载
下载地址： https://www.pgyer.com/mgBfu6

# 下载安装GoldenDict
选择以下可用方案下载安装即可
1. 下载链接： http://market.android.com/details?id=mobi.goldendict.android.free 
2. 如果用浏览器无法下载安装GoldenDict，自行打开Android手机自带的应用市场，搜素GoldenDict，如果这里搜索的到，下载安装亦可。
...
# 下载词库文件，并放置在手机存储器根目录下的GoldenDict
下载链接: https://pan.baidu.com/s/1oV6AxRUlX1c7mpE352bt8w 提取码: uxtw
1. Android 手机下载以下词库文件即可，下载完毕**解压**（注意⚠️，必须解压），并放到手机存储器的GoldenDict 目录。具体操作步骤可参考下一节，或者自行Google 百度。
...
2. 重新启动GoldenDict，开始索引词库。完毕后可以在搜索框输入单词查询。
